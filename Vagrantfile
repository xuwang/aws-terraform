...
apt-get update; apt-get install -y python-pip jq unzip git mysql-client-core-5.6 postgresql-client-9.3 graphviz
...
unzip -q -o terraform_0.6.16_linux_amd64.zip
popd
