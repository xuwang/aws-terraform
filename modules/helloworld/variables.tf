...
variable "keypair" { default = "helloworld" }
...
variable "vpc_id" { }
variable "vpc_cidr" { }
variable "helloworld_subnet_a_id" { }
variable "helloworld_subnet_b_id" { }
variable "helloworld_subnet_c_id" { }
variable "helloworld_subnet_az_a" { }
variable "helloworld_subnet_az_b" { }
variable "helloworld_subnet_az_c" { }