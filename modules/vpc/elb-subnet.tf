  ...
  # by the same script, according to the selected AWS region
		...
		variable "elb_subnet_az_a" { default = "sa-east-1a" }
		variable "elb_subnet_b" { default = "10.0.41.0/24" }
		variable "elb_subnet_az_b" { default = "sa-east-1b" }
		variable "elb_subnet_c" { default = "10.0.42.0/24" }
		variable "elb_subnet_az_c" { default = "sa-east-1c" }
