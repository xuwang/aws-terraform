  ...
  # by the same script, according to the selected AWS region
		...
		variable "etcd_subnet_az_a" { default = "sa-east-1a" }
		variable "etcd_subnet_b" { default = "10.0.11.0/24" }
		variable "etcd_subnet_az_b" { default = "sa-east-1b" }
		variable "etcd_subnet_c" { default = "10.0.12.0/24" }
		variable "etcd_subnet_az_c" { default = "sa-east-1c" }
